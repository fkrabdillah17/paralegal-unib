...
@section('content')
    <div class="p-2 mt-5 pt-5">
        <div class="container-fluid px-5">
            <div class="row">
                <h2 class="text-center titleBar" style="font-weight: bold">Pencarian Berita Seputar Paralegal FH UNIB</h2>
                <h2 class="text-center pb-5">"{{ $key }}"</h2>
                <div class="col-lg-9 py-2 ">
                    @if ($countdata != 0)
                                ...
                                <div class="row g-0">
                                    <div class="col-md-3 d-flex align-items-stretch">
                                        <a href="{{ route('news.detail', $item->slug) }}">
                                            <img src="{{ asset('assets/files/pictures/arsip/' . $item->thumbnail) }}" class="img-fluid rounded-start"
                                                alt="...">
                                        </a>
                                    </div>
                                    <div class="col-md-8">
                        ...
                        @endforeach
                    @else
                        <h2 class="text-capitalize text-center">Maaf, Data yang anda cari tidak ada</h2>
                    @endif
