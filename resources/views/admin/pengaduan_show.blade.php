    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if ($pengaduan->feedback != null)
                <div class="form-floating mb-3">
                    <input type="text" readonly class="form-control-plaintext border-bottom border-dark border-top-0 fw-bold"
                        value="{{ $pengaduan->penjawab->name }}">
                    <label for="floatingInput">Nama Penjawab</label>
                </div>
                <div class="form-floating mb-3">
                    <textarea type="text" readonly class="form-control-plaintext border-bottom border-dark border-top-0 fw-bold" style="height: 300px">{{ $pengaduan->feedback }}</textarea>
                    <label for="floatingInput">Tanggapan</label>
                </div>
            @else
                <div class="form-floating mb-3">
                    <input type="text" readonly class="form-control-plaintext border-bottom border-dark border-top-0 fw-bold" value="-">
                    <label for="floatingInput">Nama Penjawab</label>
                </div>
                <div class="form-floating mb-3">
                    <textarea type="text" readonly class="form-control-plaintext border-bottom border-dark border-top-0 fw-bold" style="height: 300px">-</textarea>
                    <label for="floatingInput">Tanggapan</label>
                </div>
            @endif
        </div>
