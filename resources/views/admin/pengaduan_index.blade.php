...
@section('content')
    ...
    <a href="{{ route('admin.pengaduan.create') }}" class="btn btn-primary my-2">Kirim Pengaduan</a>
    @if (session('status'))
                    ...
                    @foreach ($pengaduan as $data)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.pengaduan.show', $data->id) }}" type="button" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Detail Data"><i class="bi bi-info-square-fill text-info" style="font-size: 30px"></i></a>
                                @if ($data->status == 0)
                                    <a href="{{ route('admin.pengaduan.edit', $data->id) }}" type="button" data-bs-toggle="tooltip" data-bs-placement="top"
